  ...
  const listItems = (data.fields).map(vote =>
    ...
    <div id="field" key={vote.key}>
      ...
      <progress id="progress"
						max="100" value={(vote.votedCount * 100) / data.voted_num}>
				</progress>
      <p id="votedCount">{vote.votedCount + ru_voted(vote.votedCount)}</p>
      <input type="radio" id="radio" name="vote" value={vote.id}/>
    ...
    <div className="vote">
      ...
      <div id="author">
					<img
						src={"https://crafatar.com/avatars/" + data.uuid + "?size=32&overlay"}
						alt={data.nickname}
					/>
      ...
      {listItems}
      <p id="notifier"></p>
      <button id="vote_btn" onClick={vote}>Проголосовать!</button>
